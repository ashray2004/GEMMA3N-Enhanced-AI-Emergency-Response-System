...
# Try to use the modern weights API; if unavailable or to avoid downloads at import time,
# fall back to creating an uninitialized model (weights=None).
try:
...
# Create model; if weights is None this will create an uninitialized model (no download)
